;(function($, undefined){
	...
	var createColorPickerFactory = function() {
	...
	/**
	 * Create a new color picker instance on selected elements (available as
	 * jQuery object 'this'). It can be created in three different data sharing
	 * modes: "all" to have "global" instance, "selector" to share data with
	 * current selector matches and "none" to create one color picker per call.
	 * If not supplied as "stateSharing" option, it defaults to "all".
	 */
	$.fn.colorPicker = function(options) {
		options = options || {}
		var factory = createColorPickerFactory();
